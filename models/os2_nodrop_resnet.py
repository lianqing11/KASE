...
__all__ =['os2_nodrop_resnet34','os2_nodrop_resnet50','os2_nodrop_resnet101', 'os2_nodrop_resnet152']
...
class DomainAdaptModule(nn.Module):
    ...
    def uos2_source_layer(self, source_bn):
...
def os2_nodrop_resnet34(pretrained=False, **kwargs):
...
def os2_nodrop_resnet50(pretrained=False, **kwargs):
...
def os2_nodrop_resnet101(pretrained=False, **kwargs):
...
def os2_nodrop_resnet152(pretrained=False, **kwargs):
